...
tf.flags.DEFINE_string("filter_sizes", "7,5", "Size of convolution kernel. Comma-separated filter sizes (default: '3,4,5')")
tf.flags.DEFINE_string("num_filters", "8,14", "Number of filters per filter size (default: 128)")
tf.flags.DEFINE_integer("hidden_unit", 200, "Rnn hidden size (default: 128)")
tf.flags.DEFINE_float("dropout_keep_prob", 0.5, "Dropout keep probability (default: 0.5)")
tf.flags.DEFINE_float("l2_reg_lambda", 0.0, "L2 regularization lambda (default: 0.0)")
tf.flags.DEFINE_integer("top_k", 5, " first layer of k max pooling k size")
tf.flags.DEFINE_integer("k1", 10, " second layer of k max pooling k size")
# Training parameters
        ...
        with sess.as_default():
            ...
            def dev_step(x_batch, y_batch, x_real_len_batch, writer=None):
                ...
                for batch in dev_batches:
                    ...
                    step,  pred, correct_pred_num = sess.run(
                        [global_step,  obj.predictions, obj.correct_pred_num],
                        feed_dict)
